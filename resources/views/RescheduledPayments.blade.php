                         ...
                         <table class="table mt-3">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>4,570,905</td>
                                    <td>22-11-2022</td>
                                    <td><span style="background-color: #01801a39"  class="border  opacity-25 px-3 py-1 rounded text-success">cleared</span></td> 
                                ...
                                <tr>
                                    ...
                                    <td>4,570,905</td>
                                    <td>22-11-2022</td>
                                    <td><span style="background-color: #e8840223" class="border px-3 py-1 opacity-25 rounded border-warning text-warning">cleared</span></td> 
                                    <td><i class="bi bi-eye-fill m-1 text-primary"></i></td>                                                                    
