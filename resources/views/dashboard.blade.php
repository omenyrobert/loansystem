                ...
                <div class="row">
                    <div class="col-md-3 p-2">
                        <div class="bg-white shadow-sm p-3" style="border-radius: 15px; height: 130px;">
                            ...
                            <br/>
                            <h4 style="color: #008ad3;">{{count(\App\Models\Loan::all())}}</h4>
                        </div>
                    </div>
                    <div class="col-md-3 p-2">
                        <div class="bg-white shadow-sm p-3" style="border-radius: 15px; height: 130px;">
                            ...
                            <h4 style="color: #008ad3;">{{count(\App\Models\Client::all())}}</h4>
                        </div>
                ...
                <div class="row mt-2">
                    <div class="col-md-6">
                        <div class="bg-white p-5 mt-2 shadow" style="border-radius: 15px; height: 70vh;">  
                            <canvas id="myChart" style="width: 90%; height: 500px;"></canvas>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="bg-white p-5 mt-2 shadow ml-2 chart-container" style="border-radius: 15px; display: flex;
                        height: 70vh;">  
                            <canvas id="myChart2" style="width: 90%; margin: auto; height: 500px;"></canvas>
                        </div>
                    </div>
